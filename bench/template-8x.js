...
block('i-ua').match(function() {
    ...
    match(function() { return this._nonce; }).addAttrs()(function() {
...
block('b-page').elem('js').addAttrs()(function() {
    return this.ctx.url ?
        { src: this.ctx.url } :
...
block('b-page')(
    ...
    elem('body').addMix()(function() {
        return this._mixJsParams;
    })
);
...
// autogenerated from b-page__css.bemhtml
block('b-page').elem('css').addAttrs().match(function() {
    return this.ctx.url;
})(function() {
    return {
        rel: 'stylesheet',
...
block('i-flashcookie')(
    ...
    js()(true),
    addJs().match(function() { return this.ctx.mode; })(function() {
        return {
            mode: this.ctx.mode
        };
    }),
...
block('paranja').match(function() {
    ...
    return { onmousedown: this.ctx.counter };
});
...
block('logo')(
    match(function() { return !this.mods.lang; }).addMix()(function() {
        return [{
            mods: {
...
block('logo').elem('link').addAttrs()(function() {
    return { tabindex: -1 };
});
...
block('suggest2-item').mod('interact', 'link')(
    ...
    }).elem('text').addMix()({mods: {type: 'url'}}));
...
block('link').mod('disabled', 'yes').addAttrs()(function() {
    return {
        tabindex: -1,
        'aria-disabled': true
    };
...
block('copyright').elem('link').match(function() { return this._inFooter; }).addMix()([{
    block: 'footer',
    elem: 'link'
}]);
...
block('footer').match(function() { return this.ctx.bg; }).addAttrs()(function() {
    return { style: 'background-color:' + this.ctx.bg };
});
...
block('serp-list').addAttrs()(function() {
    return {
        role: this.ctx.role,
...
block('serp-adv').elem('banner').addAttrs()(function() {
    return {
        onmousedown: this.ctx.counter
    };
});
...
// autogenerated from serp-adv__banner.bemhtml
block('serp-adv').elem('banner').addMix()([{
...
block('serp-adv').elem('counter')(
    match(function() { return this.ctx.js; })
      .tag()('span'),
...
block('button').mod('disabled', 'yes').addAttrs()(function() {
    var ctx = this.ctx,
        a = {};
...
block('image').mod('placeholder', 'yes').addMix()({ block: 'content-placeholder' });
...
block('serp-list').mod('right', 'yes').addAttrs()({
    role: 'complementary',
...
block('navigation')(
    ...
    elem('more-label').addAttrs()(function() {
        return {
            tabindex: 0,
            role: 'button',
            'title': 'more',
...
block('input').mod('readonly', 'yes').elem('control').addAttrs()(function() {
    return {
        readonly: 'readonly'
    };
});
...
block('check-button').elem('text').addAttrs()(function() {
    return {
...
block('select').elem('list').addAttrs()(function() {
    return { role: 'select' };
});
...
block('select').elem('item').addAttrs()(function() {
    return {
...
block('select').mod('multiple', 'yes').elem('control').addAttrs()(function() {
...
block('radiobox').elem('control')(
    tag()('input'),
    addAttrs()(function() { return this._controlAttrs; })
);
...
block('distro').elem('icon').addAttrs()(function() {
    return {
...
block('b-menu-vert').match(function() { return this._inDropdownMenu; })(
    ...
    elem('item').addAttrs()({role: 'menuitem'})
);
...
block('b-menu-horiz').match(function() {
    ...
    elem('layout-unit').addMix()(function() {
        var mix = [];
...
block('footer-stripe').elem('text').addAttrs()(function() {
    return {
        onmousedown: this.ctx.counter
    };
})
...
block('tooltip').mod('size', 'xs').addJs()(function() {
    return {
        tailWidth: 14,
        tailHeight: 7
    };
...
block('button2').mod('type', 'submit').addAttrs()(function() {
    return { type: 'submit' };
});
...
block('tooltip').mod('size', 's').addJs()(function() {
    return {
        tailWidth: 14,
        tailHeight: 7
    };
...
block('tooltip').mod('size', 'l').addJs()(function() {
    return {
        tailWidth: 24,
        tailHeight: 12
    };
...
block('check-button').mod('pseudo', 'yes')(
    ...
    elem('control').addAttrs()(function() {
        return { value: '' };
    })
);
...
block('internal-stripe').elem('content').addAttrs()(function() {
    return { onmousedown: this.ctx.counter };
});
...
block('tumbler').elem('button').match(function() {
    ...
    return { 'aria-labelledby': this._sideId };
});
...
block('tumbler').elem('sticker').addAttrs()(function() {
...
block('lang-switcher')(
    ...
    elem('lang').addAttrs()(function() {
        return { onmousedown: this._counterOpen };
    })
);
...
block('input').mod('type', 'password').elem('control').addAttrs()(function() {
...
block('i-geo-point').addAttrs()(function() {
    return {
...
block('map2')(
    ...
    elem('preloader-container').addAttrs()(function() {
        return {
            id: this.ctx.id
        };
    }),
...
block('people').elem('avatar')(
    ...
    addMix()({ block: 'content-placeholder' }),
    addAttrs()(function() {
        return this.ctx.src && {
...
block('sport-icon')(
    tag()('span'),
    mod('type', 'country').addAttrs()(function() {
        return {
            style: ('background-position:-' + this.ctx.spriteOffset + 'px -2px')
        };
    }),
    mod('type', 'team').addAttrs()(function() {
        return {
...
block('tabs-panes').elem('pane').addAttrs()(function() {
    return {
        role: 'tabpanel',
...
block('notice').elem('count')(
    ...
    match(function() { return !this.ctx.url; }).addMix()([{
        elem: 'plain'
    }]),
...
block('z-default-search').mod('sharer', 'yes')(
    addJs()(function() {
        return { sharerWindowName: 'z-default-search_sharer_yes' };
    }),
...
block('z-panorama').elem('pane').addMix()({
    block: 'content-placeholder'
});
...
//    }
block('input').match(function() { return this._inSlider; }).addMix()([{
    block: 'slider',
    elem: 'input'
}]);
...
block('slider').elem('mark').addAttrs()({
    'aria-hidden': true
});
...
block('input').elem('message').elemMod('type', 'error').addAttrs()({
    role: 'alert'
});
...
block('input').elem('message').elemMod('visibility', 'visible').addAttrs()(function() {
...
block('z-colors')(
    ...
    elem('table-cell').addAttrs()(function() {
        return {
            style: 'background-color:#' + this.ctx.hexValue + ';' +
                'color:#' + this.ctx.js.contrastValue + ';'
        };
    }),
    elem('table-cell').mod('selected', 'yes').addAttrs()(function() {
        return {
            style: 'background-color:#' + this.ctx.hexValue + ';' +
                'color:#' + this.ctx.js.contrastValue + ';' +
...
block('z-colors-input').addMix()({ block: 'clearfix' });
...
block('z-contest')(
    ...
    elem('sportcar').addAttrs()(function() {
        return {
...
block('z-market').elem('text-link').addAttrs()(function() {
    return {
        onmousedown: this.ctx.counter
    };
});
...
block('z-math').elem('layout-left').addMix()({
    block: 'content-placeholder'
});
...
block('z-parallels').elem('image').addAttrs()(function() {
    return {
...
block('z-tournament-table')(
    addAttrs()({ role: 'grid' }),
    elem('head')(
        addAttrs()({ role: 'rowgroup' }),
        def()(function() {
            return applyNext({ _inHead: true })
        })
    ),
    elem('body').addAttrs()({ role: 'rowgroup' }),
    elem('footer').addAttrs()({ role: 'rowgroup' }),
    elem('row').addAttrs()({ role: 'row' }),
    elem('cell').addAttrs()(function() { return { role: this._inHead ? 'columnheader' : 'gridcell' }})
);
...
block('z-video').elem('thumb-favicon').addAttrs()(function() {
...
block('z-weather').elem('day').addAttrs()(function() {
    return {
...
block('z-weather').elem('night').addAttrs()(function() {
    return {
        style: 'background: #' + this.ctx.bgColor
    };
});
