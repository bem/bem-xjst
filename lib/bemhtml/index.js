...
BEMHTML.prototype.render = function(context, entity, tag, js, bem, cls, mix,
  ...
  var isJsInitNeeded = isBEM && jsParams && (
  ...
  if (cls)
    classValue += (isBEM ? ' ' : '') +
      (typeof cls === 'string' ? utils.attrEscape(cls).trim() : cls);
...
BEMHTML.prototype.renderMix = function(entity, mix, jsParams, isJsInitNeeded) {
  var visited = {};
  var ret = {
    out: '',
    jsParams: jsParams,
