...
BEMHTML.prototype.compile = function(code) {
  var self = this;
...
BEMHTML.prototype.recompileInput = function(code) {
...
BEMHTML.prototype.groupEntities = function(tree) {
  var res = {};
...
BEMHTML.prototype.transformEntities = function(entities) {
  var wildcardElems = [];
...
BEMHTML.prototype._run = function(context) {
  var res;
...
BEMHTML.prototype.run = function(json) {
...
BEMHTML.prototype.runEmpty = function() {
...
BEMHTML.prototype.runSimple = function(context) {
  this.context._listLength--;
  var res = '';
...
BEMHTML.prototype.runOne = function(json) {
  var context = this.context;
...
BEMHTML.prototype.tryRun = function(context, ent) {
  try {
...
BEMHTML.prototype.renderContent = function(content, isBEM) {
  var context = this.context;
...
BEMHTML.prototype.renderNoTag = function(context,
                                         js,
                                         bem,
                                         cls,
                                         mix,
...
BEMHTML.prototype.local = function(changes, body) {
...
BEMHTML.prototype.applyNext = function() {
  return this.match.exec(this.context);
};

BEMHTML.prototype.applyMode = function(mode, changes) {
...
BEMHTML.prototype.exportApply = function(exports) {
  var self = this;
