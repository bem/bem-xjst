...
MatchProperty.prototype.exec = function(context) {
...
MatchAbsent.prototype.exec = function(context) {
...
MatchOnce.prototype.exec = function(context) {
...
Match.prototype.clone = function(entity) {
