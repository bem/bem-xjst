module.exports = function() {
  ...
  function replace() {
    var self = this;
    return function (body) { return self.def()(function () { return applyCtx(body()) }) };
  };
  function extend() {
    var self = this;
    return function (body) { return self.def()(function () { return applyCtx(this.extend(this.ctx, body())) }) };
  };
