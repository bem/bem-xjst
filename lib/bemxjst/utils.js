...
var SHORT_TAGS = { // hash for quick check if tag short
  area: 1, base: 1, basefont: 1, br: 1, col: 1, command: 1, embed: 1, hr: 1,
  img: 1, input: 1, isindex: 1, keygen: 1, link: 1, meta: 1, param: 1,
  source: 1, track: 1, wbr: 1,
  // svg
  path: 1, circle: 1, ellipse: 1, line: 1, rect: 1, use: 1, stop: 1,
  polyline: 1, polygon: 1
};
