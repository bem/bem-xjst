...
AddMatch.prototype.mixWrapBody = function mixWrapBody(body) {
  ...
  if (typeof body !== 'function') {
    return function inlineMixAddAdaptor() {
      var ret = apply('mix');
...
Tree.methods = [
  ...
  'addElemMods', 'elemMods', 'elemMod', 'def', 'tag', 'addAttrs', 'attrs',
  'cls', 'addJs', 'js', 'bem', 'addMix', 'mix', 'content', 'replace', 'extend',
  'oninit', 'xjstOptions', 'appendContent', 'prependContent'
];
