...
VIDOM.isOneElement = function(children) {
...
VIDOM.prototype._run = function _run(context) {
  ...
  // FIXME: it could be useful
  // if (typeof context === 'object' && context.$$typeof) {
  //   return context;
  // }
...
VIDOM.prototype.render = function render(
  ...
  if (!isBEM && !cls) {
    ...
    if (children) {
      if (VIDOM.isOneElement(children)) {
