...
# 2019-05-17 [v7.8.1](https://github.com/bem/bem-xjst/compare/v7.8.0...v7.8.1), @tadatuta

Performance optimization of `utils.isSimple` (issue #544).
BEMHTML: Roll back `Set` optimization in BEMHTML.prototype.renderMix (introduced in #541).

# 2019-05-07 [v7.8.0](https://github.com/bem/bem-xjst/compare/v7.7.7...v7.8.0), @tadatuta

BEMHTML: performance optimization in BEMHTML.prototype.renderMix (issue #541).
bem-xjst: export BEMXJSTError.
...
Commits:
* [[`0c67103fbb`](https://github.com/bem/bem-xjst/commit/0c67103fbb)] - Provide arguments for extend() mode (Vladimir Grinenko)


# 2016-11-28 [v7.6.0](https://github.com/bem/bem-xjst/compare/v7.5.0...v7.6.0), @miripiruni

Port from v8.4.0. New option `unquotedAttrs`. See [docs](https://github.com/bem/bem-xjst/blob/master/docs/en/3-api.md#unquoted-attributes).

Commits:
* [[`7eff482a7b`](https://github.com/bem/bem-xjst/commit/7eff482a7b)] - **BEMHTML**: support unquoted attributes (fix for #364) (miripiruni)


# 2016-11-09 [v7.5.0](https://github.com/bem/bem-xjst/compare/v7.4.1...v7.5.0), @miripiruni
...
Commits:
* [[`f0e8fc07cd`](https://github.com/bem/bem-xjst/commit/f0e8fc07cd)] - **BEMHTML**: Omit optional closing tags (fix for #360) (miripiruni)
